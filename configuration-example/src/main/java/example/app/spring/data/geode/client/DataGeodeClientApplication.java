...
package example.app.spring.data.geode.client;
 ...
 * @see example.app.spring.data.geode.server.DataGeodeServerApplication
 * @since 1.0.0
 */
...
public class DataGeodeClientApplication implements CommandLineRunner {
	...
	public static void main(String[] args) {
		SpringApplication.run(DataGeodeClientApplication.class, args);
	}
