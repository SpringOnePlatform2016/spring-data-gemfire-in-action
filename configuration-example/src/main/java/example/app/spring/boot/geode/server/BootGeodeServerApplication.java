...
package example.app.spring.boot.geode.server;
...
/**
 * The BootGeodeServerApplication class is a {@link SpringBootApplication} that configures and bootstraps
...
public class BootGeodeServerApplication {
	...
	public static void main(String[] args) {
		SpringApplication.run(BootGeodeServerApplication.class, args);
	}

	String applicationName() {
		return BootGeodeServerApplication.class.getSimpleName();
	}
